...
CREATE TABLE public.entity_semantic_identifier (
	...
	CONSTRAINT fkinjr1aqio6tuon2ypi6ixd4ao FOREIGN KEY (entity_id) REFERENCES public.entity("uuid") ON DELETE CASCADE,
...
CREATE TABLE public.field_type (
	...
	subfields text DEFAULT '[]'::text NULL,
...
CREATE TABLE public.network (
	...
	"attributes" text DEFAULT '{}'::text NULL,
	metadataprefix varchar(255) DEFAULT 'oai_dc'::character varying NULL,
	metadatastoreschema varchar(255) DEFAULT 'xoai'::character varying NULL,
	originurl varchar(255) DEFAULT NULL::character varying NULL,
	properties text DEFAULT '{}'::text NULL,
	"sets" text DEFAULT '[]'::text NULL,
...
CREATE TABLE public.oairecord (
	id int8 DEFAULT nextval('oai_record_id_seq'::regclass) NOT NULL,
	datestamp timestamp NOT NULL,
	identifier varchar(255) NOT NULL,
	originalmetadatahash varchar(32) DEFAULT NULL::character varying NULL,
	publishedmetadatahash varchar(32) DEFAULT NULL::character varying NULL,
...
CREATE TABLE public.source_entity_semantic_identifier (
	...
	CONSTRAINT fkequg2xow14h1xdkde3c2q92o0 FOREIGN KEY (entity_id) REFERENCES public.source_entity("uuid") ON DELETE CASCADE
);
CREATE INDEX idx_sesi_entity_id_semantic_id ON public.source_entity_semantic_identifier USING btree (entity_id, semantic_id);
...
CREATE TABLE public.source_relation (
	...
	CONSTRAINT fkirpb50vicfsbg28olx4snn39s FOREIGN KEY (to_entity_id) REFERENCES public.source_entity("uuid") ON DELETE CASCADE,
	CONSTRAINT fkpiife6ava2qdk9y42tr4u5bci FOREIGN KEY (from_entity_id) REFERENCES public.source_entity("uuid") ON DELETE CASCADE
);
...
CREATE TABLE public.relation (
	...
	CONSTRAINT fk9kavjxgi0tpvju15iab7petiw FOREIGN KEY (from_entity_id) REFERENCES public.entity("uuid") ON DELETE CASCADE,
	CONSTRAINT fk9wvqikvahl1a0x1xkcfdw42n FOREIGN KEY (to_entity_id) REFERENCES public.entity("uuid") ON DELETE CASCADE,
	CONSTRAINT fks2nk3th0n2lygksxkloek4gd1 FOREIGN KEY (relation_type_id) REFERENCES public.relation_type(id)
);
CREATE INDEX idx_from_entity_id ON public.relation USING btree (from_entity_id);
CREATE INDEX idx_to_entity_id ON public.relation USING btree (to_entity_id);
...
CREATE TABLE public.relation_fieldoccr (
	...
	CONSTRAINT relation_fieldoccr_entityfrom_uuid_fk FOREIGN KEY (from_entity_id) REFERENCES public.entity("uuid") ON DELETE CASCADE,
	CONSTRAINT relation_fieldoccr_entityto_uuid_fk FOREIGN KEY (to_entity_id) REFERENCES public.entity("uuid") ON DELETE CASCADE
);
...
CREATE TABLE public.source_entity_fieldoccr (
	...
	CONSTRAINT fk2f3wc4b3huh74134hloikiou7 FOREIGN KEY (entity_id) REFERENCES public.source_entity("uuid") ON DELETE CASCADE,
...
CREATE TABLE public.source_relation_fieldoccr (
	...
	CONSTRAINT source_relation_fieldoccr_source_entityfrom_uuid_fk FOREIGN KEY (from_entity_id) REFERENCES public.source_entity("uuid") ON DELETE CASCADE,
	CONSTRAINT source_relation_fieldoccr_source_entityto_uuid_fk FOREIGN KEY (to_entity_id) REFERENCES public.source_entity("uuid") ON DELETE CASCADE
);
...
CREATE TABLE public.entity_fieldoccr (
	...
	CONSTRAINT fkg85y6bnncn3q9y762wvrwj08u FOREIGN KEY (entity_id) REFERENCES public.entity("uuid") ON DELETE CASCADE
);
